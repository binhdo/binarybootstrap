...
function binarybootstrap_setup() {
	...
	register_nav_menu( 'primary', __( 'Navigation Menu', 'binarybootstrap' ) );
...
function binarybootstrap_scripts_styles() {
	...
	wp_enqueue_style( 'binarybootstrap-ie', get_template_directory_uri() . '/css/ie.css', array( 'binarybootstrap-style' ), '20130213' );
	$wp_styles->add_data( 'binarybootstrap-ie', 'conditional', 'lt IE 9' );
}
