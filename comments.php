 ...
 * handled by a callback to binarybootstrap_comment() which is
...
?>
	...
	?>
		<div class="alert alert-error fade in no-comments"><?php _e( 'Comments are closed.', 'binarybootstrap' ); ?></div>
	<?php endif; ?>
