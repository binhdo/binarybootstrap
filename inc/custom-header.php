...
function binarybootstrap_custom_header_setup() {
	...
	register_default_headers( array(
		'circle' => array(
			...
			'description'   => _x( 'Circle', 'header image description', 'binarybootstrap' )
		),
		'diamond' => array(
			'url'           => '%s/images/headers/diamond.png',
			'thumbnail_url' => '%s/images/headers/diamond-thumbnail.png',
			'description'   => _x( 'Diamond', 'header image description', 'binarybootstrap' )
		),
		'star' => array(
			'url'           => '%s/images/headers/star.png',
			'thumbnail_url' => '%s/images/headers/star-thumbnail.png',
			'description'   => _x( 'Star', 'header image description', 'binarybootstrap' )
		),
	) );

	add_action( 'admin_print_styles-appearance_page_custom-header', 'binarybootstrap_fonts' );
}
...
function binarybootstrap_header_style() {
	...
	?>
	<style type="text/css" id="binarybootstrap-header-css">
	<?php
...
function binarybootstrap_admin_header_style() {
	$header_image = get_header_image();
?>
	<style type="text/css" id="binarybootstrap-admin-header-css">
